...
export const RESOURCES = {
  ...
  faculty: {
    ...
    fields: [F('name', 'Name', 'text', { required: true }), F('designation', 'Designation'),
             F('qualification', 'Qualification'), F('dateOfJoining', 'Date of Joining', 'date'),
  ...
  downloads: {
    ...
    fields: [F('title', 'Title', 'text', { required: true }), F('date', 'Date', 'date'), F('category', 'Category'),
             F('section', 'Section', 'select', { required: true, options: [
               ...
               { value: 'iso', label: 'ISO' },
               { value: 'alumni', label: 'Students — Alumni' },
               { value: 'students-club', label: 'Students — Students Club' },
               { value: 'student-activities', label: 'Students — Student Activities' },
             ] }),
