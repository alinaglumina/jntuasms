...
const SITE = 'JNTUA SMS';
const SITE_FULL = 'School of Management Studies (SMS)';
const DEFAULT_DESC = 'JNTUA School of Management Studies — a constituent institute of JNTU Anantapur offering management education, research and training.';
